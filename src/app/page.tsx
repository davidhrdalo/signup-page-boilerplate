...
export default async function Home() {
  const jsonLd = {
    ...
    description:
      "Join our beta and help shape the future of product development.",
            ...
            <div className="flex flex-col lg:flex-row items-center gap-12">
              ...
              <div className="flex-1 text-center lg:text-left">
                ...
                <p className="text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-xl mx-auto lg:mx-0">
                  Join thousands of makers and creators who are building the
                  future with our powerful platform.
                </p>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                  <SignupDialog>
                    <Button
                      size="lg"
                      className="bg-gradient-to-r from-violet-600 to-indigo-600 hover:from-violet-700 hover:to-indigo-700 dark:from-violet-500 dark:to-indigo-500 dark:hover:from-violet-600 dark:hover:to-indigo-600"
                    >
                      Get Started
